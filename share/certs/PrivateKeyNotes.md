...
unlocked to sign the Fincoin-Qt.app bundle.
...
allowing somebody to distribute a Fincoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the fincoin-qt.exe file inside the installer had not been tampered with.
